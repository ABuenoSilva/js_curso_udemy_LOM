...
var GeraCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeraCPF, [{
    ...
    value: function geraNovoCPF() {
      ...
      var digito1 = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].calculaDigito(cpfSemDigito);
      var digito2 = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].calculaDigito(cpfSemDigito + digito1);
...
var ValidaCPF = /*#__PURE__*/function () {
  ...
  _createClass(ValidaCPF, [{
    key: "verifica",
    value: function verifica() {
      var cpfLimpo = this.cpf.replace(/\D+/g, '');
      ...
      var cpfCorreto = cpfLimpo.slice(0, -2);
    ...
    key: "calculaDigito",
    value: function calculaDigito(cpf) {
      var arrayCPF = Array.from(cpf).map(function (v) {
        return parseInt(v);
      });
      var mult = arrayCPF.length + 1;
      var soma = arrayCPF.map(function (v, i) {
        return v * (mult - i);
      }).reduce(function (a, v) {
        return a + v;
      });
...
(function () {
  ...
  cpfGerado.innerHTML = new _modules_GeraCPF__WEBPACK_IMPORTED_MODULE_0__["default"]().geraNovoCPF();
})();
})();
